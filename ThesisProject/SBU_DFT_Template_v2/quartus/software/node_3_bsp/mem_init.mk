...
# Memory: data_mem_3
MEM_0 := qsys_system_data_mem_3
$(MEM_0)_NAME := data_mem_3
...
$(MEM_0)_END := 0x0001fcff
$(MEM_0)_SPAN := 0x00007d00
$(MEM_0)_HIERARCHICAL_PATH := data_mem_3
$(MEM_0)_WIDTH := 32
...
.PHONY: data_mem_3
data_mem_3: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
