...
# Memory: data_mem_1
MEM_0 := qsys_system_data_mem_1
$(MEM_0)_NAME := data_mem_1
...
$(MEM_0)_END := 0x00025fff
$(MEM_0)_SPAN := 0x00006000
$(MEM_0)_HIERARCHICAL_PATH := data_mem_1
$(MEM_0)_WIDTH := 32
...
.PHONY: data_mem_1
data_mem_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
