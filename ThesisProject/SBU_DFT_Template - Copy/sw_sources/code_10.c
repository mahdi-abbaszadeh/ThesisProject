...
int main()
{
  ...
  init_input_fifo_wrclk_control(FIFO_SINK_10_IN_CSR_BASE);
  init_input_fifo_wrclk_control(FIFO_SOURCE_10_IN_CSR_BASE);

  alt_putstr("source status:\n");
  print_status(FIFO_SOURCE_10_IN_CSR_BASE);

  alt_putstr("sink status:\n");
  print_status(FIFO_SINK_10_IN_CSR_BASE);
...
//  altera_avalon_fifo_write_fifo(MM2STFIFO_1_IN_BASE, MM2STFIFO_1_IN_CSR_BASE,85);
  ...
  status = altera_avalon_fifo_read_status(FIFO_SINK_10_IN_CSR_BASE,ALTERA_AVALON_FIFO_STATUS_ALL);
  while(status & 0x02){
  	  status = altera_avalon_fifo_read_status(FIFO_SINK_10_IN_CSR_BASE,ALTERA_AVALON_FIFO_STATUS_ALL);
    }
  ...
  value = altera_avalon_fifo_read_fifo(FIFO_SINK_10_OUT_BASE, FIFO_SINK_10_IN_CSR_BASE);
  printf("value = %d\n",value);
  value = altera_avalon_fifo_read_fifo(FIFO_SINK_10_OUT_BASE, FIFO_SINK_10_IN_CSR_BASE);
  printf("value = %d\n",value);
  value = altera_avalon_fifo_read_fifo(FIFO_SINK_10_OUT_BASE, FIFO_SINK_10_IN_CSR_BASE);
  ...
  send_packet(FIFO_SOURCE_10_IN_BASE,FIFO_SOURCE_10_IN_CSR_BASE,0x2,0x3,0x20,array);
  /*altera_avalon_fifo_write_fifo(FIFO_SOURCE_10_IN_BASE, FIFO_SOURCE_10_IN_CSR_BASE,0x00200203);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_10_IN_BASE, FIFO_SOURCE_10_IN_CSR_BASE,0x02000000);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_10_IN_BASE, FIFO_SOURCE_10_IN_CSR_BASE,temp);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_10_IN_BASE, FIFO_SOURCE_10_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_10_IN_BASE, FIFO_SOURCE_10_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_10_IN_BASE, FIFO_SOURCE_10_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_10_IN_BASE, FIFO_SOURCE_10_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_10_IN_BASE, FIFO_SOURCE_10_IN_CSR_BASE,0x0);*/
