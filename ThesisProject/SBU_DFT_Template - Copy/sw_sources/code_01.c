...
//  altera_avalon_fifo_write_fifo(MM2STFIFO_1_IN_BASE, MM2STFIFO_1_IN_CSR_BASE,85);
  ...
  /*altera_avalon_fifo_write_fifo(FIFO_SOURCE_01_IN_BASE, FIFO_SOURCE_01_IN_CSR_BASE,0x00200102);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_01_IN_BASE, FIFO_SOURCE_01_IN_CSR_BASE,0x01000000);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_01_IN_BASE, FIFO_SOURCE_01_IN_CSR_BASE,temp);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_01_IN_BASE, FIFO_SOURCE_01_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_01_IN_BASE, FIFO_SOURCE_01_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_01_IN_BASE, FIFO_SOURCE_01_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_01_IN_BASE, FIFO_SOURCE_01_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_01_IN_BASE, FIFO_SOURCE_01_IN_CSR_BASE,0x0);
