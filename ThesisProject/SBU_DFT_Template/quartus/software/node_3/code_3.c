  ...
  int main()
  {
    ...
    receive_poll(FIFO_SINK_3_IN_CSR_BASE,ALTERA_AVALON_FIFO_STATUS_ALL);
    ...
    receive_packet(FIFO_SINK_3_OUT_BASE,FIFO_SINK_3_IN_CSR_BASE,receive_array);

    alt_putstr("write to FIFO\n");
    send_packet(FIFO_SOURCE_3_IN_BASE,FIFO_SOURCE_3_IN_CSR_BASE,0x3,0x0,0x20,send_array);
