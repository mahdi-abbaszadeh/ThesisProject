...
//  altera_avalon_fifo_write_fifo(MM2STFIFO_1_IN_BASE, MM2STFIFO_1_IN_CSR_BASE,85);
  ...
  value = altera_avalon_fifo_read_fifo(FIFO_SINK_2_OUT_BASE, FIFO_SINK_2_IN_CSR_BASE);
  printf("value = %d\n",value);
  value = altera_avalon_fifo_read_fifo(FIFO_SINK_2_OUT_BASE, FIFO_SINK_2_IN_CSR_BASE);
  printf("value = %d\n",value);
  value = altera_avalon_fifo_read_fifo(FIFO_SINK_2_OUT_BASE, FIFO_SINK_2_IN_CSR_BASE);
  ...
  send_packet(FIFO_SOURCE_2_IN_BASE,FIFO_SOURCE_2_IN_CSR_BASE,0x2,0x3,0x20,array);
  /*altera_avalon_fifo_write_fifo(FIFO_SOURCE_2_IN_BASE, FIFO_SOURCE_2_IN_CSR_BASE,0x00200203);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_2_IN_BASE, FIFO_SOURCE_2_IN_CSR_BASE,0x02000000);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_2_IN_BASE, FIFO_SOURCE_2_IN_CSR_BASE,temp);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_2_IN_BASE, FIFO_SOURCE_2_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_2_IN_BASE, FIFO_SOURCE_2_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_2_IN_BASE, FIFO_SOURCE_2_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_2_IN_BASE, FIFO_SOURCE_2_IN_CSR_BASE,0x0);
  altera_avalon_fifo_write_fifo(FIFO_SOURCE_2_IN_BASE, FIFO_SOURCE_2_IN_CSR_BASE,0x0);*/
