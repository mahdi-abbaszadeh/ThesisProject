...
set sys_clk   "u1|altpll_component|auto_generated|pll1|clk[0]"
set sdram_pll "u1|altpll_component|auto_generated|pll1|clk[1]"
...
set_min_delay -from $sdram_pll -to [get_ports {sdram_clk}] 1
set_max_delay -from $sdram_pll -to [get_ports {sdram_clk}] 6
