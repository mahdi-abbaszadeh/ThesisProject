...
module unsaved_mm_interconnect_0 (
	...
	wire  [94:0] mm2stfifo_0_in_agent_rf_source_data;                                                // MM2STFIFO_0_in_agent:rf_source_data -> MM2STFIFO_0_in_agent_rsp_fifo:in_data
	...
	wire  [94:0] mm2stfifo_0_in_agent_rsp_fifo_out_data;                                             // MM2STFIFO_0_in_agent_rsp_fifo:out_data -> MM2STFIFO_0_in_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> MM2STFIFO_0_in_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // MM2STFIFO_0_in_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> MM2STFIFO_0_in_agent:cp_channel
	...
	wire  [94:0] mm2stfifo_0_in_csr_agent_rf_source_data;                                            // MM2STFIFO_0_in_csr_agent:rf_source_data -> MM2STFIFO_0_in_csr_agent_rsp_fifo:in_data
	...
	wire  [94:0] mm2stfifo_0_in_csr_agent_rsp_fifo_out_data;                                         // MM2STFIFO_0_in_csr_agent_rsp_fifo:out_data -> MM2STFIFO_0_in_csr_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> MM2STFIFO_0_in_csr_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // MM2STFIFO_0_in_csr_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> MM2STFIFO_0_in_csr_agent:cp_channel
	...
	wire  [94:0] st2mmfifo_0_in_csr_agent_rf_source_data;                                            // ST2MMFIFO_0_in_csr_agent:rf_source_data -> ST2MMFIFO_0_in_csr_agent_rsp_fifo:in_data
	...
	wire  [94:0] st2mmfifo_0_in_csr_agent_rsp_fifo_out_data;                                         // ST2MMFIFO_0_in_csr_agent_rsp_fifo:out_data -> ST2MMFIFO_0_in_csr_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> ST2MMFIFO_0_in_csr_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // ST2MMFIFO_0_in_csr_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> ST2MMFIFO_0_in_csr_agent:cp_channel
	...
	wire  [94:0] st2mmfifo_0_out_agent_rf_source_data;                                               // ST2MMFIFO_0_out_agent:rf_source_data -> ST2MMFIFO_0_out_agent_rsp_fifo:in_data
	...
	wire  [94:0] st2mmfifo_0_out_agent_rsp_fifo_out_data;                                            // ST2MMFIFO_0_out_agent_rsp_fifo:out_data -> ST2MMFIFO_0_out_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> ST2MMFIFO_0_out_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // ST2MMFIFO_0_out_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> ST2MMFIFO_0_out_agent:cp_channel
	...
	wire  [93:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire         mm2stfifo_0_in_agent_rp_valid;                                                      // MM2STFIFO_0_in_agent:rp_valid -> router_004:sink_valid
	wire  [93:0] mm2stfifo_0_in_agent_rp_data;                                                       // MM2STFIFO_0_in_agent:rp_data -> router_004:sink_data
	wire         mm2stfifo_0_in_agent_rp_ready;                                                      // router_004:sink_ready -> MM2STFIFO_0_in_agent:rp_ready
	wire         mm2stfifo_0_in_agent_rp_startofpacket;                                              // MM2STFIFO_0_in_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         mm2stfifo_0_in_agent_rp_endofpacket;                                                // MM2STFIFO_0_in_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         mm2stfifo_0_in_csr_agent_rp_valid;                                                  // MM2STFIFO_0_in_csr_agent:rp_valid -> router_005:sink_valid
	wire  [93:0] mm2stfifo_0_in_csr_agent_rp_data;                                                   // MM2STFIFO_0_in_csr_agent:rp_data -> router_005:sink_data
	wire         mm2stfifo_0_in_csr_agent_rp_ready;                                                  // router_005:sink_ready -> MM2STFIFO_0_in_csr_agent:rp_ready
	wire         mm2stfifo_0_in_csr_agent_rp_startofpacket;                                          // MM2STFIFO_0_in_csr_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         mm2stfifo_0_in_csr_agent_rp_endofpacket;                                            // MM2STFIFO_0_in_csr_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         st2mmfifo_0_in_csr_agent_rp_valid;                                                  // ST2MMFIFO_0_in_csr_agent:rp_valid -> router_006:sink_valid
	wire  [93:0] st2mmfifo_0_in_csr_agent_rp_data;                                                   // ST2MMFIFO_0_in_csr_agent:rp_data -> router_006:sink_data
	wire         st2mmfifo_0_in_csr_agent_rp_ready;                                                  // router_006:sink_ready -> ST2MMFIFO_0_in_csr_agent:rp_ready
	wire         st2mmfifo_0_in_csr_agent_rp_startofpacket;                                          // ST2MMFIFO_0_in_csr_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         st2mmfifo_0_in_csr_agent_rp_endofpacket;                                            // ST2MMFIFO_0_in_csr_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         st2mmfifo_0_out_agent_rp_valid;                                                     // ST2MMFIFO_0_out_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] st2mmfifo_0_out_agent_rp_data;                                                      // ST2MMFIFO_0_out_agent:rp_data -> router_007:sink_data
	wire         st2mmfifo_0_out_agent_rp_ready;                                                     // router_007:sink_ready -> ST2MMFIFO_0_out_agent:rp_ready
	wire         st2mmfifo_0_out_agent_rp_startofpacket;                                             // ST2MMFIFO_0_out_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         st2mmfifo_0_out_agent_rp_endofpacket;                                               // ST2MMFIFO_0_out_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [93:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_008:sink_data
