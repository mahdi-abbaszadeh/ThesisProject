...
`timescale 1 ps / 1 ps
module NoC_QSYS_mm_interconnect_1 (
		input  wire        clk_0_clk_clk,                              //                            clk_0_clk.clk
		input  wire        nios2_10_reset_reset_bridge_in_reset_reset, // nios2_10_reset_reset_bridge_in_reset.reset
	...
	wire         rsp_mux_src_valid;                                                              // rsp_mux:src_valid -> nios2_10_data_master_agent:rp_valid
	wire  [91:0] rsp_mux_src_data;                                                               // rsp_mux:src_data -> nios2_10_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                              // nios2_10_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [5:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> nios2_10_data_master_agent:rp_channel
	wire         rsp_mux_src_startofpacket;                                                      // rsp_mux:src_startofpacket -> nios2_10_data_master_agent:rp_startofpacket
	wire         rsp_mux_src_endofpacket;                                                        // rsp_mux:src_endofpacket -> nios2_10_data_master_agent:rp_endofpacket
	...
	wire         rsp_mux_001_src_valid;                                                          // rsp_mux_001:src_valid -> nios2_10_instruction_master_agent:rp_valid
	wire  [91:0] rsp_mux_001_src_data;                                                           // rsp_mux_001:src_data -> nios2_10_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                          // nios2_10_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [5:0] rsp_mux_001_src_channel;                                                        // rsp_mux_001:src_channel -> nios2_10_instruction_master_agent:rp_channel
	wire         rsp_mux_001_src_startofpacket;                                                  // rsp_mux_001:src_startofpacket -> nios2_10_instruction_master_agent:rp_startofpacket
	wire         rsp_mux_001_src_endofpacket;                                                    // rsp_mux_001:src_endofpacket -> nios2_10_instruction_master_agent:rp_endofpacket
	...
	wire  [92:0] nios2_10_debug_mem_slave_agent_rf_source_data;                                  // nios2_10_debug_mem_slave_agent:rf_source_data -> nios2_10_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [92:0] nios2_10_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_10_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_10_debug_mem_slave_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                              // cmd_mux:src_valid -> nios2_10_debug_mem_slave_agent:cp_valid
	wire  [91:0] cmd_mux_src_data;                                                               // cmd_mux:src_data -> nios2_10_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                              // nios2_10_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [5:0] cmd_mux_src_channel;                                                            // cmd_mux:src_channel -> nios2_10_debug_mem_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                      // cmd_mux:src_startofpacket -> nios2_10_debug_mem_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                        // cmd_mux:src_endofpacket -> nios2_10_debug_mem_slave_agent:cp_endofpacket
	...
	wire  [92:0] fifo_source_10_in_agent_rf_source_data;                                         // fifo_source_10_in_agent:rf_source_data -> fifo_source_10_in_agent_rsp_fifo:in_data
	...
	wire  [92:0] fifo_source_10_in_agent_rsp_fifo_out_data;                                      // fifo_source_10_in_agent_rsp_fifo:out_data -> fifo_source_10_in_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                          // cmd_mux_001:src_valid -> fifo_source_10_in_agent:cp_valid
	wire  [91:0] cmd_mux_001_src_data;                                                           // cmd_mux_001:src_data -> fifo_source_10_in_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                          // fifo_source_10_in_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> fifo_source_10_in_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                  // cmd_mux_001:src_startofpacket -> fifo_source_10_in_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                    // cmd_mux_001:src_endofpacket -> fifo_source_10_in_agent:cp_endofpacket
	...
	wire  [92:0] fifo_sink_10_in_csr_agent_rf_source_data;                                       // fifo_sink_10_in_csr_agent:rf_source_data -> fifo_sink_10_in_csr_agent_rsp_fifo:in_data
	...
	wire  [92:0] fifo_sink_10_in_csr_agent_rsp_fifo_out_data;                                    // fifo_sink_10_in_csr_agent_rsp_fifo:out_data -> fifo_sink_10_in_csr_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                          // cmd_mux_002:src_valid -> fifo_sink_10_in_csr_agent:cp_valid
	wire  [91:0] cmd_mux_002_src_data;                                                           // cmd_mux_002:src_data -> fifo_sink_10_in_csr_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                          // fifo_sink_10_in_csr_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                        // cmd_mux_002:src_channel -> fifo_sink_10_in_csr_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                  // cmd_mux_002:src_startofpacket -> fifo_sink_10_in_csr_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                    // cmd_mux_002:src_endofpacket -> fifo_sink_10_in_csr_agent:cp_endofpacket
	...
	wire  [92:0] fifo_source_10_in_csr_agent_rf_source_data;                                     // fifo_source_10_in_csr_agent:rf_source_data -> fifo_source_10_in_csr_agent_rsp_fifo:in_data
	...
	wire  [92:0] fifo_source_10_in_csr_agent_rsp_fifo_out_data;                                  // fifo_source_10_in_csr_agent_rsp_fifo:out_data -> fifo_source_10_in_csr_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                          // cmd_mux_003:src_valid -> fifo_source_10_in_csr_agent:cp_valid
	wire  [91:0] cmd_mux_003_src_data;                                                           // cmd_mux_003:src_data -> fifo_source_10_in_csr_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                          // fifo_source_10_in_csr_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                        // cmd_mux_003:src_channel -> fifo_source_10_in_csr_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                  // cmd_mux_003:src_startofpacket -> fifo_source_10_in_csr_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                    // cmd_mux_003:src_endofpacket -> fifo_source_10_in_csr_agent:cp_endofpacket
	...
	wire  [92:0] fifo_sink_10_out_agent_rf_source_data;                                          // fifo_sink_10_out_agent:rf_source_data -> fifo_sink_10_out_agent_rsp_fifo:in_data
	...
	wire  [92:0] fifo_sink_10_out_agent_rsp_fifo_out_data;                                       // fifo_sink_10_out_agent_rsp_fifo:out_data -> fifo_sink_10_out_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                          // cmd_mux_004:src_valid -> fifo_sink_10_out_agent:cp_valid
	wire  [91:0] cmd_mux_004_src_data;                                                           // cmd_mux_004:src_data -> fifo_sink_10_out_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                          // fifo_sink_10_out_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                        // cmd_mux_004:src_channel -> fifo_sink_10_out_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                  // cmd_mux_004:src_startofpacket -> fifo_sink_10_out_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                    // cmd_mux_004:src_endofpacket -> fifo_sink_10_out_agent:cp_endofpacket
	...
	wire  [92:0] data_mem_10_s1_agent_rf_source_data;                                            // data_mem_10_s1_agent:rf_source_data -> data_mem_10_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] data_mem_10_s1_agent_rsp_fifo_out_data;                                         // data_mem_10_s1_agent_rsp_fifo:out_data -> data_mem_10_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                          // cmd_mux_005:src_valid -> data_mem_10_s1_agent:cp_valid
	wire  [91:0] cmd_mux_005_src_data;                                                           // cmd_mux_005:src_data -> data_mem_10_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                          // data_mem_10_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                        // cmd_mux_005:src_channel -> data_mem_10_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                  // cmd_mux_005:src_startofpacket -> data_mem_10_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                    // cmd_mux_005:src_endofpacket -> data_mem_10_s1_agent:cp_endofpacket
	wire         nios2_10_data_master_agent_cp_valid;                                            // nios2_10_data_master_agent:cp_valid -> router:sink_valid
	wire  [91:0] nios2_10_data_master_agent_cp_data;                                             // nios2_10_data_master_agent:cp_data -> router:sink_data
	wire         nios2_10_data_master_agent_cp_ready;                                            // router:sink_ready -> nios2_10_data_master_agent:cp_ready
	wire         nios2_10_data_master_agent_cp_startofpacket;                                    // nios2_10_data_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire         nios2_10_data_master_agent_cp_endofpacket;                                      // nios2_10_data_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire         nios2_10_instruction_master_agent_cp_valid;                                     // nios2_10_instruction_master_agent:cp_valid -> router_001:sink_valid
	wire  [91:0] nios2_10_instruction_master_agent_cp_data;                                      // nios2_10_instruction_master_agent:cp_data -> router_001:sink_data
	wire         nios2_10_instruction_master_agent_cp_ready;                                     // router_001:sink_ready -> nios2_10_instruction_master_agent:cp_ready
	wire         nios2_10_instruction_master_agent_cp_startofpacket;                             // nios2_10_instruction_master_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire         nios2_10_instruction_master_agent_cp_endofpacket;                               // nios2_10_instruction_master_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire         nios2_10_debug_mem_slave_agent_rp_valid;                                        // nios2_10_debug_mem_slave_agent:rp_valid -> router_002:sink_valid
	wire  [91:0] nios2_10_debug_mem_slave_agent_rp_data;                                         // nios2_10_debug_mem_slave_agent:rp_data -> router_002:sink_data
	wire         nios2_10_debug_mem_slave_agent_rp_ready;                                        // router_002:sink_ready -> nios2_10_debug_mem_slave_agent:rp_ready
	wire         nios2_10_debug_mem_slave_agent_rp_startofpacket;                                // nios2_10_debug_mem_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         nios2_10_debug_mem_slave_agent_rp_endofpacket;                                  // nios2_10_debug_mem_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         fifo_source_10_in_agent_rp_valid;                                               // fifo_source_10_in_agent:rp_valid -> router_003:sink_valid
	wire  [91:0] fifo_source_10_in_agent_rp_data;                                                // fifo_source_10_in_agent:rp_data -> router_003:sink_data
	wire         fifo_source_10_in_agent_rp_ready;                                               // router_003:sink_ready -> fifo_source_10_in_agent:rp_ready
	wire         fifo_source_10_in_agent_rp_startofpacket;                                       // fifo_source_10_in_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         fifo_source_10_in_agent_rp_endofpacket;                                         // fifo_source_10_in_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         fifo_sink_10_in_csr_agent_rp_valid;                                             // fifo_sink_10_in_csr_agent:rp_valid -> router_004:sink_valid
	wire  [91:0] fifo_sink_10_in_csr_agent_rp_data;                                              // fifo_sink_10_in_csr_agent:rp_data -> router_004:sink_data
	wire         fifo_sink_10_in_csr_agent_rp_ready;                                             // router_004:sink_ready -> fifo_sink_10_in_csr_agent:rp_ready
	wire         fifo_sink_10_in_csr_agent_rp_startofpacket;                                     // fifo_sink_10_in_csr_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         fifo_sink_10_in_csr_agent_rp_endofpacket;                                       // fifo_sink_10_in_csr_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         fifo_source_10_in_csr_agent_rp_valid;                                           // fifo_source_10_in_csr_agent:rp_valid -> router_005:sink_valid
	wire  [91:0] fifo_source_10_in_csr_agent_rp_data;                                            // fifo_source_10_in_csr_agent:rp_data -> router_005:sink_data
	wire         fifo_source_10_in_csr_agent_rp_ready;                                           // router_005:sink_ready -> fifo_source_10_in_csr_agent:rp_ready
	wire         fifo_source_10_in_csr_agent_rp_startofpacket;                                   // fifo_source_10_in_csr_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         fifo_source_10_in_csr_agent_rp_endofpacket;                                     // fifo_source_10_in_csr_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         fifo_sink_10_out_agent_rp_valid;                                                // fifo_sink_10_out_agent:rp_valid -> router_006:sink_valid
	wire  [91:0] fifo_sink_10_out_agent_rp_data;                                                 // fifo_sink_10_out_agent:rp_data -> router_006:sink_data
	wire         fifo_sink_10_out_agent_rp_ready;                                                // router_006:sink_ready -> fifo_sink_10_out_agent:rp_ready
	wire         fifo_sink_10_out_agent_rp_startofpacket;                                        // fifo_sink_10_out_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         fifo_sink_10_out_agent_rp_endofpacket;                                          // fifo_sink_10_out_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         data_mem_10_s1_agent_rp_valid;                                                  // data_mem_10_s1_agent:rp_valid -> router_007:sink_valid
	wire  [91:0] data_mem_10_s1_agent_rp_data;                                                   // data_mem_10_s1_agent:rp_data -> router_007:sink_data
	wire         data_mem_10_s1_agent_rp_ready;                                                  // router_007:sink_ready -> data_mem_10_s1_agent:rp_ready
	wire         data_mem_10_s1_agent_rp_startofpacket;                                          // data_mem_10_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         data_mem_10_s1_agent_rp_endofpacket;                                            // data_mem_10_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         nios2_10_debug_mem_slave_agent_rdata_fifo_src_valid;                            // nios2_10_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] nios2_10_debug_mem_slave_agent_rdata_fifo_src_data;                             // nios2_10_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         nios2_10_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter:in_0_ready -> nios2_10_debug_mem_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                  // avalon_st_adapter:out_0_valid -> nios2_10_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                   // avalon_st_adapter:out_0_data -> nios2_10_debug_mem_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                  // nios2_10_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                  // avalon_st_adapter:out_0_error -> nios2_10_debug_mem_slave_agent:rdata_fifo_sink_error
	wire         fifo_source_10_in_agent_rdata_fifo_src_valid;                                   // fifo_source_10_in_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] fifo_source_10_in_agent_rdata_fifo_src_data;                                    // fifo_source_10_in_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         fifo_source_10_in_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_001:in_0_ready -> fifo_source_10_in_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                              // avalon_st_adapter_001:out_0_valid -> fifo_source_10_in_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                               // avalon_st_adapter_001:out_0_data -> fifo_source_10_in_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                              // fifo_source_10_in_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                              // avalon_st_adapter_001:out_0_error -> fifo_source_10_in_agent:rdata_fifo_sink_error
	wire         fifo_sink_10_in_csr_agent_rdata_fifo_src_valid;                                 // fifo_sink_10_in_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] fifo_sink_10_in_csr_agent_rdata_fifo_src_data;                                  // fifo_sink_10_in_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         fifo_sink_10_in_csr_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_002:in_0_ready -> fifo_sink_10_in_csr_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                              // avalon_st_adapter_002:out_0_valid -> fifo_sink_10_in_csr_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                               // avalon_st_adapter_002:out_0_data -> fifo_sink_10_in_csr_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                              // fifo_sink_10_in_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                              // avalon_st_adapter_002:out_0_error -> fifo_sink_10_in_csr_agent:rdata_fifo_sink_error
	wire         fifo_source_10_in_csr_agent_rdata_fifo_src_valid;                               // fifo_source_10_in_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] fifo_source_10_in_csr_agent_rdata_fifo_src_data;                                // fifo_source_10_in_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         fifo_source_10_in_csr_agent_rdata_fifo_src_ready;                               // avalon_st_adapter_003:in_0_ready -> fifo_source_10_in_csr_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                              // avalon_st_adapter_003:out_0_valid -> fifo_source_10_in_csr_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                               // avalon_st_adapter_003:out_0_data -> fifo_source_10_in_csr_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                              // fifo_source_10_in_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                              // avalon_st_adapter_003:out_0_error -> fifo_source_10_in_csr_agent:rdata_fifo_sink_error
	wire         fifo_sink_10_out_agent_rdata_fifo_src_valid;                                    // fifo_sink_10_out_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] fifo_sink_10_out_agent_rdata_fifo_src_data;                                     // fifo_sink_10_out_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         fifo_sink_10_out_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_004:in_0_ready -> fifo_sink_10_out_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                              // avalon_st_adapter_004:out_0_valid -> fifo_sink_10_out_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                               // avalon_st_adapter_004:out_0_data -> fifo_sink_10_out_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                              // fifo_sink_10_out_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                              // avalon_st_adapter_004:out_0_error -> fifo_sink_10_out_agent:rdata_fifo_sink_error
	wire         data_mem_10_s1_agent_rdata_fifo_src_valid;                                      // data_mem_10_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] data_mem_10_s1_agent_rdata_fifo_src_data;                                       // data_mem_10_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         data_mem_10_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_005:in_0_ready -> data_mem_10_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                              // avalon_st_adapter_005:out_0_valid -> data_mem_10_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                               // avalon_st_adapter_005:out_0_data -> data_mem_10_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                              // data_mem_10_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                              // avalon_st_adapter_005:out_0_error -> data_mem_10_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_master_translator #(
		...
		.reset                  (nios2_10_reset_reset_bridge_in_reset_reset),                              //                     reset.reset
	...
	altera_merlin_master_agent #(
		...
		.clk                   (clk_0_clk_clk),                                                           //       clk.clk
		.reset                 (nios2_10_reset_reset_bridge_in_reset_reset),                              // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_router router (
	...
	NoC_QSYS_mm_interconnect_1_router_001 router_001 (
	...
	NoC_QSYS_mm_interconnect_1_router_002 router_002 (
	...
	NoC_QSYS_mm_interconnect_1_router_003 router_003 (
	...
	NoC_QSYS_mm_interconnect_1_router_003 router_004 (
	...
	NoC_QSYS_mm_interconnect_1_router_003 router_005 (
	...
	NoC_QSYS_mm_interconnect_1_router_003 router_006 (
	...
	NoC_QSYS_mm_interconnect_1_router_002 router_007 (
	...
	NoC_QSYS_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_cmd_mux_001 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_cmd_demux_001 rsp_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_rsp_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_cmd_demux_001 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_1_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios2_10_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NoC_QSYS_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (nios2_10_reset_reset_bridge_in_reset_reset),          // in_rst_0.reset
